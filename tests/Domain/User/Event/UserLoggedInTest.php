...
/**
 * @covers \Oqq\EsUserLogin\Domain\User\Event\UserLoggedIn
 */
final class UserLoggedInTest extends TestCase
{
    ...
    public function it_creates_event(): void
    {
        ...
        $event = UserLoggedIn::withIdentity($userId, $identityId);
    ...
    public function it_creates_event_from_payload(): void
    {
        ...
        $event = UserLoggedIn::occur($userId->toString(), $payload);
